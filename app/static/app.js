...
function renderRfq(state) {
  if (!state || !state.rfq_id) { $('rfqStatus').textContent = '未创建'; $('rfqId').textContent = '--'; $('rfqExpires').textContent = '--'; $('rfqQuoteCount').textContent = '0'; $('rfqQuotes').className = 'rfq-quotes empty'; $('rfqQuotes').textContent = '暂无报价'; return; }
